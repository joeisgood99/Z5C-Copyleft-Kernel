...
cd ../final_files/
mv $FINALFILES/boot_E5823.img $FINALFILES/CopyLeft_32-3-A-2-33_v3-10-91_boot.img
...
echo "CopyLeft_32-3-A-2-33_3-10-v91_boot.img $(($DIFF / 60)) minute(s) and $(($DIFF % 60)) seconds."
else
