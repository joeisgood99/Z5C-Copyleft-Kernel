...
TCPATH="/home/ben/AOSP_6.0_R58/prebuilts/gcc/linux-x86/aarch64/aarch64-linux-android-4.9/bin/aarch64-linux-android-"
...
make msm8994-Kali-perf_defconfig ARCH=arm64 CROSS_COMPILE=$TCPATH
...
cd ../final_files/
mv $FINALFILES/boot_E5823.img $FINALFILES/305boot.img
zip -r Z5C_Joeisgood99_v.zip 305boot.img META-INF  
rm -f boot.img
