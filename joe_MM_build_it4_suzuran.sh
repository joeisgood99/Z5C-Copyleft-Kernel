...
TCPATH="/home/ben/ubertc/out/aarch64-linux-android-4.9-kernel/bin/aarch64-linux-android-"
...
cd ../final_files/
mv $FINALFILES/boot_E5823.img $FINALFILES/New-kali-305boot.img
zip -r Z5C_kali-305-boot_v.zip New-kali-305boot.img META-INF  
rm -f boot.img
...
echo "Z5C_kali-305-boot_v.zip.zip completed in $(($DIFF / 60)) minute(s) and $(($DIFF % 60)) seconds."
else
