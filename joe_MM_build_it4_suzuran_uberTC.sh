...
#cd ../final_files/
#mv boot_E5823.img Uber253boot.img
#zip -r Z5C_Joeisgood99_v.zip Uber253boot.img META-INF  
#rm -f boot.img
...
#mv /home/ben/kernel-Source-Code/final_files/Z5C_Joeisgood99_v.zip  /home/ben/kernel-Source-Code/final_files/UberZ5C_Joeisgood99_v$version.zip
